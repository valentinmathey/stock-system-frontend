  ...
  return (
    <>
      <button
        ...
        className="bg-violet-600 text-white px-3 py-1.5 rounded inline-flex items-center gap-1"
      >
        Acciones <MoreVertical size={14} />
      </button>
      ...
      {open && (
        ...
        >
          <div className="bg-white rounded-lg shadow-xl w-64 p-4">
            ...
            >
              <ListIcon size={16} /> Ver lista de artículos
            </button>
            ...
            <button
              ...
              className="mt-1 flex w-full items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 text-sm"
            >
              <PenSquare size={16} /> Editar proveedor
            </button>
