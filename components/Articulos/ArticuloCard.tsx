        ...
        <table className="w-full text-sm text-gray-700">
          <thead className="bg-gray-100 text-xs text-gray-600 uppercase">
            <tr>
              ...
              <th className="px-3 py-3 text-center">Stock seguridad</th>
              <th className="px-3 py-3 text-center">Costo Almacenamiento</th>
              <th className="px-3 py-3 text-center">Precio Venta</th>
              <th className="px-3 py-3 text-center">CGI</th>
              <th className="px-3 py-3 text-center">Lote Óptimo</th>
              <th className="px-3 py-3 text-center">Punto Pedido</th>
              <th className="px-3 py-3 text-center">Inventario Máximo</th>
              <th className="px-3 py-3 text-center">Demanda Anual</th>
              <th className="px-3 py-3 text-center">Variación Demanda</th>
              <th className="px-3 py-3 text-center whitespace-nowrap">Proveedor</th>
          ...
          <tbody>
            {articulos.map((a) => (
              <tr key={a.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-3 py-2 text-center">{a.stockSeguridad}</td>
                ...
                <td className="px-3 py-2 text-center">{a.cgi?.toFixed(2)}</td>
                <td className="px-3 py-2 text-center">
